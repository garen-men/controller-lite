...
import { CLEANUP_TIMER_LOOP_MILLIS, createTrackingData } from "./createTrackingData"
...
export function createTimerBasedReactionCleanupTracking() {
     ...
     */
    const uncommittedReactionRefs: Set<React.MutableRefObject<any>> = new Set()
    ...
    function recordReactionAsCommitted(
        reactionRef: React.MutableRefObject<any>
    ) {
    ...
    return {
        addReactionToTrack(
            reactionTrackingRef: React.MutableRefObject<any>,
            reaction: Reaction,
            /**
